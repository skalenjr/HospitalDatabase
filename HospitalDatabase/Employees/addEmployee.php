...
if ($_SERVER['REQUEST_METHOD'] != 'POST') {
    ...
    try {
        ...
        INSERT IGNORE INTO Employee(hire_date, salary, department_ID, job_title, SSN) VALUES(CURDATE(), :salary, :department_ID, :job_title, (select SSN from employees where SSN=:SSN));");
