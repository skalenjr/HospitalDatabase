...
$stmt = $conn->prepare("select prescriptionID, Prescription.pID, visitID, medication, directions, start_date, end_date, first_name, last_name from Prescription, Person, Patient where Person.SSN = Patient.SSN order by Patient.pID");
$stmt->execute();
