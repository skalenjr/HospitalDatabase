...
$stmt = $conn->prepare("select prescriptionID, pID, visitID, medication, directions, start_date, end_date from Prescription Person, Patient where Person.SSN = Patient.SSN order by Patient.pID");
$stmt->execute();
