...
if (isset($_GET['pID']))
{
    ...
    echo "<thead><tr><th style='width:5%'>Patient ID</th><th style='width:15%'>SSN</th><th style='width:20%'>First name</th style='width:15%'><th>Last name</th><th style='width:20%'>Type Of Insurance</th><th style='width:45%' style='text-align:right'>Address</th></tr></thead>";
    echo "<tbody>";
