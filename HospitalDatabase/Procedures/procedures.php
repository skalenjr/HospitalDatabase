...
$stmt = $conn->prepare("select Procedure.procedureID, Person.first_name, Person.last_name, from Person, Patient, Procedure where Procedure.pID = Patient.pID and Person.SSN = Patient.SSN order by Procedure.procedureID");
$stmt->execute();
