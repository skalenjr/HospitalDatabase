...
$stmt = $conn->prepare("select Procedures.procID, Person.first_name, Person.last_name from Person, Patient, Procedures where Procedures.pID = Patient.pID and Person.SSN = Patient.SSN order by Procedure.procedureID");
$stmt->execute();
