...
$stmt = $conn->prepare("select Procedure.procedureID, Person.first_name, Person.last_name,  from Person, Procedure where Procedure.pID = Patient.pID order by Procedure.procedureID");
$stmt->execute();
